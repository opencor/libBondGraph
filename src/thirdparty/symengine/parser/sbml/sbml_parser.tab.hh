...
/**
 ** \file sbml_parser.tab.hh
 ** Define the sbml::parser class.
 */
...
#ifndef YY_YY_SBML_PARSER_TAB_HH_INCLUDED
# define YY_YY_SBML_PARSER_TAB_HH_INCLUDED
// "%code requires" blocks.
#line 8 "sbml_parser.yy"


#include "symengine/parser/sbml/sbml_parser.h"


#line 55 "sbml_parser.tab.hh"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
        ...
        switch (this->kind ())
    {
      ...
      {}
#else
      basic_symbol (typename Base::kind_type t, const SymEngine::RCP<const SymEngine::Basic>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, SymEngine::vec_basic&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const SymEngine::vec_basic& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    ...
    parser (SymEngine::SbmlParser &p_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_NUMERIC (std::string v)
      {
        return symbol_type (token::NUMERIC, std::move (v));
      }
#else
      static
      symbol_type
...
#endif // !YY_YY_SBML_PARSER_TAB_HH_INCLUDED
